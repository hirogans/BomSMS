...
def main():
    os.system('clear')
    print logo
    print '%s[%s! %s] %sBOM SMS MANTAP BY HIRO%s:'%(hijau,kuning,hijau,cyan,merah)
    print '\n     %s{%s01%s}%s Bom Spam Ayo Src'%(hijau,kuning,hijau,hijau)
    print '     %s{%s02%s}%s Bom Spam Indihome'%(hijau,kuning,hijau,hijau)
    print '     %s{%s03%s}%s Bom Spam PHD Order'%(hijau,kuning,hijau,hijau)
    print '     %s{%s04%s}%s Bom Spam AUTMSG'%(hijau,kuning,hijau,hijau)
    print '     %s{%s05%s}%s Bom Spam Spam Kelas pintar'%(hijau,kuning,hijau,hijau)
    print '     %s{%s06%s}%s Bom Spam MAPCLUB'%(hijau,kuning,hijau,hijau)
    print '     %s{%s00%s}%s Mau Keluar'%(hijau,kuning,hijau,merah);print ''
    pilih()

def pilih():
    try:
        ab = raw_input('%s{%s~%s} %sPilih No %s:%s '%(putih,cyan,putih,biru,merah,hijau))
        if ab =='':
            print '%s{%s!%s} %sIsi Dulu Bego'%(putih,merah,putih,putih)
            pilih()
        elif ab =='1' or ab =='01': #ayosrc
            try:
                print '%s[!] %sContoh%s: %s628xxx%s[!] '%(putih,biru,hijau,merah,putih)
                nomor = raw_input('%s{%s+%s}%s Masukan Nomor  %s:%s '%(putih,hijau,putih,putih,merah,biru))
                ...
                for i in range(int(jumla)):
                    try:
                        ...
                        print '%s{%s!%s} %sPeriksa Koneksi Anda Kalo Perlu Jual Aja Tuh HP'%(putih,merah,putih,merah);exit()
                print '\n%s{%s✓%s} %sSelesai Bos %s.....'%(putih,hijau,putih,hijau,putih)
                raw_input('%s{%s!%s} %sTekan Enter Kalo Udah%s:'%(putih,merah,putih,putih,merah))
                main()
            except KeyboardInterrupt:
                print '%s{%s•%s} %sCTRL+C %sKembali'%(putih,hijau,putih,merah,putih);exit()
            except EOFError:
                print '\n%s{%s•%s} %sCTRL+D %sKembali'%(putih,hijau,putih,merah,putih);exit()
        elif ab =='2' or ab =='02': #indihome
            try:
                print '%s[!] %sContoh%s: %s08xxxx%s[!] '%(putih,biru,hijau,merah,putih)
                nomor = raw_input('%s{%s+%s}%s Masukan Nomor %s:%s '%(putih,hijau,putih,putih,merah,biru))
                jumla = raw_input('%s{%s+%s}%s Jumlah Spam  %s:%s '%(putih,hijau,putih,putih,merah,biru));print ''
                ...
                for i in range(int(jumla)):
                    try:
                        ...
                        print '%s{%s!%s} %sPeriksa Koneksi Anda Kalo Perlu Jual Tuh Hp'%(putih,merah,putih,merah);exit()
                print '\n%s{%s✓%s} %sSelesai Bos%s.....'%(putih,hijau,putih,hijau,putih)
                raw_input('%s{%s!%s} %sTekan Enter Kalo Udah%s:'%(putih,merah,putih,putih,merah))
                main()
            except KeyboardInterrupt:
            ...
            try:
                ...
                for i in range(int(jumla)):
                    try:
                        ...
                        print '%s{%s!%s} %sPeriksan Koneksi Anda Kalo Perlu Jual Tuh Hp'%(putih,merah,putih,merah);exit()
            ...
            try:
                print '%s[!] %sContoh%s: %s8xxxxx%s[!] '%(putih,biru,hijau,merah,putih)
                nomor = raw_input('%s{%s+%s}%s Masukan Nomor %s:%s '%(putih,hijau,putih,putih,merah,biru))
                jumla = raw_input('%s{%s+%s}%s Jumlah Spam  %s:%s '%(putih,hijau,putih,putih,merah,biru));print ''
